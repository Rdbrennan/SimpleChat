...
class StorageTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 0 {
            let oversizeAlert = UIAlertController(title: "", message: "Are you shure?", preferredStyle: UIAlertController.Style.actionSheet)
        ...
        if indexPath.row == 1 {
            let alert = UIAlertController(title: "", message: "Are you shure?", preferredStyle: UIAlertController.Style.actionSheet)
