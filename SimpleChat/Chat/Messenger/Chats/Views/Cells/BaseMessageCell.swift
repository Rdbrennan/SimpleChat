...
class BaseMessageCell: RevealableCollectionViewCell {
    ...
    static let selectedOutgoingBubble = UIImage(named: "OutgoingSelected")!.resizableImage(withCapInsets: UIEdgeInsets.init(top: 14, left: 14, bottom: 17, right: 28))
    static let selectedIncomingBubble = UIImage(named: "IncomingSelected")!.resizableImage(withCapInsets: UIEdgeInsets.init(top: 14, left: 22, bottom: 17, right: 20))
