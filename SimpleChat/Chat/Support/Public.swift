...
struct NameConstants {
    static let personalStorage = "SimpleChat Support"
}
...
let cameraAccessDeniedMessage = "SimpleChat needs access to your camera to take photos and videos.\n\nPlease go to Settings –– Privacy –– Camera –– and set SimpleChat to ON."
let contactsAccessDeniedMessage = "SimpleChat needs access to your contacts to create new ones.\n\nPlease go to Settings –– Privacy –– Contacts –– and set SimpleChat to ON."
let microphoneAccessDeniedMessage = "SimpleChat needs access to your microphone to record audio messages.\n\nPlease go to Settings –– Privacy –– Microphone –– and set SimpleChat to ON."
let photoLibraryAccessDeniedMessage = "SimpleChat needs access to your photo library to send photos and videos.\n\nPlease go to Settings –– Privacy –– Photos –– and set SimpleChat to ON."

let cameraAccessDeniedMessageProfilePicture = "SimpleChat needs access to your camera to take photo for your profile.\n\nPlease go to Settings –– Privacy –– Camera –– and set SimpleChat to ON."
let photoLibraryAccessDeniedMessageProfilePicture = "SimpleChat needs access to your photo library to select photo for your profile.\n\nPlease go to Settings –– Privacy –– Photos –– and set SimpleChat to ON."

let videoRecordedButLibraryUnavailableError = "To send a recorded video, it has to be saved to your photo library first. Please go to Settings –– Privacy –– Photos –– and set SimpleChat to ON."
