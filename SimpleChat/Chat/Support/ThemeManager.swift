...
enum Theme: Int {
    ...
    var incomingBubble: UIImage {
        switch self {
        case .Default:
            return UIImage(named: "DarkPigeonBubbleIncomingFull")!.resizableImage(withCapInsets: UIEdgeInsets.init(top: 14, left: 22, bottom: 17, right: 20))//UIImage(named: "PigeonBubbleIncomingFull")!.resizableImage(withCapInsets: UIEdgeInsetsMake(14, 22, 17, 20))
        case .Dark:
            return UIImage(named: "DarkPigeonBubbleIncomingFull")!.resizableImage(withCapInsets: UIEdgeInsets.init(top: 14, left: 22, bottom: 17, right: 20))
        }
    }
    ...
    var outgoingBubble: UIImage {
        switch self {
        case .Default:
            return UIImage(named: "PigeonBubbleRed")!.resizableImage(withCapInsets: UIEdgeInsets.init(top: 14, left: 14, bottom: 17, right: 28))
    ...
    var secondaryColor: UIColor {
        switch self {
        case .Default:
            return UIColor(red: 34/255.0, green: 193/255.0, blue: 100/255.0, alpha: 1.0)
        case .Dark:
...
func setGlobalNavigationBarSettingsAccordingToTheme(theme: Theme) {
    ...
    UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).defaultTextAttributes = convertToNSAttributedStringKeyDictionary([NSAttributedString.Key.foregroundColor.rawValue: theme.generalTitleColor])
}
